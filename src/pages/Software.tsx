...
import { Monitor, Apple, Laptop, Smartphone, Tablet, Globe, Phone, Download, Trash2, Package } from "lucide-react";
        ...
        <div className="container px-4">
          ...
          {loading ? (
            ...
            <div className="text-center py-16 glass-card max-w-md mx-auto">
              ...
              <Button onClick={() => navigate("/upload")} className="btn-nova text-primary-foreground border-0">
